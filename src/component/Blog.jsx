          ...
          <div className="row">
            ...
            <div className="col-sm-12 col-md-12 col-lg-6">
              <div className='blog-second-img' style={{ marginTop: '100px'}}>
                <img src={ Style } alt="" style={{width: '550px', height: '453px'}} />
              </div>
            </div>
          </div>
        </div>
